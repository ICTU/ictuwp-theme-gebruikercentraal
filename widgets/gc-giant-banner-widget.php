...
class GC_Widget_giant_banner extends WP_Widget {
	...
	function form( $instance ) {
        ...
        <p>
            ...
            <input class="widefat" id="<?php echo $this->get_field_id( 'giantbanner_url' ); ?>"
                   name="<?php echo $this->get_field_name( 'giantbanner_url' ); ?>" type="url"
                   value="<?php echo $giantbanner_url; ?>"/>
        </p>

        <p>
            <label for="<?php echo $this->get_field_id( 'giantbanner_linktext' ); ?>"><?php _e( 'Link-tekst', 'gebruikercentraal' ) ?></label>
            <input class="widefat" id="<?php echo $this->get_field_id( 'giantbanner_linktext' ); ?>"
                   name="<?php echo $this->get_field_name( 'giantbanner_linktext' ); ?>" type="text"
                   value="<?php echo $giantbanner_linktext; ?>"/>
        </p>

        <p>
            <label for="<?php echo $this->get_field_id( 'giantbanner_text' ); ?>"><?php _e( 'Tekst', 'gebruikercentraal' ) ?></label>
            <textarea rows="10" class="widefat" id="<?php echo $this->get_field_id( 'giantbanner_text' ); ?>"
                      name="<?php echo $this->get_field_name( 'giantbanner_text' ); ?>"><?php echo $giantbanner_text; ?></textarea>
        </p>

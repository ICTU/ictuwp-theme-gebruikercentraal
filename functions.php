...
// @license GPL-2.0+
// @version 4.3.25.p
// @desc.   Werking nav-menu voor desktop aangepast.
...
define( 'CHILD_THEME_VERSION', '4.3.25.p' );
define( 'CHILD_THEME_DESCRIPTION', "4.3.25.p - Werking nav-menu voor desktop aangepast." );

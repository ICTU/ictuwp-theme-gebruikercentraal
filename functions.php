...
define( 'CHILD_THEME_VERSION', '4.3.1' );
define( 'CHILD_THEME_DESCRIPTION', "4.3.1 - Fixes voor actieteamwidget bug (sanitize_title) en authorbox (get user ID from get_queried_object)." );

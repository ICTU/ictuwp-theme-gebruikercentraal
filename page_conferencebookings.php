...
/**
// Gebruiker Centraal - page_conferencebookings.php
// ----------------------------------------------------------------------------------
...
//* Template Name: GC - Conferentiereserveringen

add_action( 'genesis_entry_content', 'gc_wbvb_show_page_overzichtspagina2', 11 );

function gc_wbvb_show_page_overzichtspagina2() {
  
  echo 'Overzichtspagina 2';
  <?php
  /*
